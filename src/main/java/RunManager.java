...
public class RunManager {
    ...
    public static void main2() {
        ...
        System.setProperty("webdriver.chrome.driver", "D:\\java_Project\\lib\\Новая папка\\chromedriver.exe");
        WebDriver driver = new ChromeDriver();
        try {
            ...
            WebElement container_Line = container.findElement(By.className("container__line"));
            //WebElement attMarket = container_Line.findElement(By.name("market"));
